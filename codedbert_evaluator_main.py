...
from codedbert_evaluator_parser import Evaluation_negpairs, get_all_paired_test_set
...
def test(dataset, device, save_file_name, pretrained_model=None, random_patches=False):
    ...
    if pretrained_model != None:
        evaluator = codedbertEvaluator.from_pretrained(pretrained_model, return_dict=True)
    else:
        evaluator = codedbertEvaluator.from_pretrained('bert-base-uncased', return_dict=True)
...
if __name__ == '__main__':
    ...
    #     eval_set_path = '../../../__codedbert_trained/codedbert_vanilla_adaptive/evaluation_set_codedbert_vanilla.pkl'
    #     path_to_trained_model = '../../../__codedbert_trained/codedbert_vanilla_adaptive/'
    #     path_to_save_json = '../../../__codedbert_trained/codedbert_vanilla_adaptive/results.json'
