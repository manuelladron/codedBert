...
class codedbertAtt(transformers.BertPreTrainedModel):
...
def set_model(pretrained_model, sample, device, path_to_dataset):
    if pretrained_model != None:
        viz = codedbertAtt.from_pretrained(pretrained_model,
                                             output_hidden_states=True,
                                             output_attentions=True,
                                             return_dict=True)
    else:
        viz = codedbertAtt.from_pretrained('bert-base-uncased',
                                             output_hidden_states=True,
                                             output_attentions=True,
                                             return_dict=True)
...
def main():
    ...
    st.sidebar.write('*Cuquilla Sofa by Markus Johansson')
    ...
    # dataset_path2 = '/Users/manuelladron/iCloud_archive/Documents/_CMU/PHD-CD/PHD-CD_Research/github/__codedbert_trained/pickle_files/rp_nm_res50/rp_nm_res50_eval_dataset.pkl'
    dataset_path = '/Users/manuelladron/iCloud_archive/Documents/_CMU/PHD-CD/PHD-CD_Research/github/__codedbert_trained/pickle_files/np_nm_res50/evaluation_set_codedbert_vanilla.pkl'
    model_path = '/Users/manuelladron/iCloud_archive/Documents/_CMU/PHD-CD/PHD-CD_Research/github/__codedbert_trained/codedbert_np_nm_10epochs/'
    # model_path2 = '/Users/manuelladron/iCloud_archive/Documents/_CMU/PHD-CD/PHD-CD_Research/github/__codedbert_trained/codedbert_np_nm_10epochs'

    # model_path = '/Users/manuelladron/iCloud_archive/Documents/_CMU/PHD-CD/PHD-CD_Research/github/__codedbert_trained/codedbert_07:33:58_rp_am_10e_manuel/'
